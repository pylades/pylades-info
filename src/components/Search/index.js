...
import { useAllPairsInPylades, useAllTokensInPylades } from '../../contexts/GlobalData'
...
export const Search = ({ small = false }) => {
  let allTokens = useAllTokensInPylades()
  const allTokenData = useAllTokenData()

  let allPairs = useAllPairsInPylades()
        ...
        <Input
          ...
          placeholder={
            small
              ...
              : 'Search Pylades pairs and tokens...'
          }
          value={value}
          onChange={(e) => {
